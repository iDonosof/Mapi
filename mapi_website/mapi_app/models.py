...
class Event(models.Model):
    ...
    event_coordinates_altitude = models.CharField(max_length = 100, null = False, blank = False)
...
class Workshop(models.Model):
    ...
    image_route = models.ImageField(upload_to = 'events/%Y/%m/%d', blank = True, null = True)
    workshop_coordinates_altitude = models.CharField(max_length = 100, null = False, blank = False)
...
class Entertainment_areas(models.Model):
    ...
    image_route = models.ImageField(upload_to = 'events/%Y/%m/%d', blank = True, null = True)
    area_coordinates_altitude = models.CharField(max_length = 100, null = False, blank = False)
